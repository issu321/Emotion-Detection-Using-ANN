...
# ================================================================================
#  EMOTION DETECTION USING ANN — Linux/Kali Installer
#  Author: issu321 (github.com/issu321)
#  Repo: https://github.com/issu321/Emotion-Detection-Using-ANN
# ================================================================================
...
hacker_boot() {
    ...
    printf '\n'
    sleep 0.2
    typewriter "[KERNEL] Loading neural network protocols..." 0.02
    printf '\n'
    sleep 0.2
    typewriter "[DAEMON] Mounting emotion detection engine..." 0.02
    printf '\n'
    sleep 0.2
...
typewriter "██                                                        ██" 0.005
printf '\n'
typewriter "██   EMOTION DETECTION USING ANN                        ██" 0.005
printf '\n'
typewriter "██   Linux / Kali / macOS | Python | ANN Edition          ██" 0.005
printf '\n'
typewriter "██   github.com/issu321                                   ██" 0.005
printf '\n'
typewriter "██   github.com/issu321/Emotion-Detection-Using-ANN       ██" 0.005
printf '\n'
...
echo ""
echo "  ╔═══════════════════════════════════════════════════════════════╗"
echo "  ║     EMOTION DETECTION USING ANN — INSTALLER                 ║"
echo "  ║     Linux / Kali / macOS | Python | ANN Edition             ║"
echo "  ║     github.com/issu321 | Emotion-Detection-Using-ANN        ║"
echo "  ╚═══════════════════════════════════════════════════════════════╝"
printf '\033[0m'

echo ""
echo -e "${MAGENTA}=========================================================${NC}"
echo -e "${GREEN}             Emotion Detection Using ANN${NC}"
...
echo ""
echo -e "${GREEN}[OK]${NC} Python detected: $PYTHON_CMD ($($PYTHON_CMD --version 2>&1))"
echo ""
...
if [ "$USER_INPUT" = "yes" ]; then
    printf '\033[0;34m'
    typewriter "[1/4] Creating virtual environment..." 0.03
    printf '\n'
    printf '\033[0m'
    ...
    echo ""
    printf '\033[0;34m'
    typewriter "[2/4] Activating virtual environment..." 0.03
    printf '\n'
    printf '\033[0m'
    ...
    echo ""
    printf '\033[0;34m'
    typewriter "[3/4] Installing dependencies..." 0.03
    printf '\n'
    printf '\033[0m'
    ...
    printf '\033[0;34m'
    typewriter "[1/2] Installing dependencies..." 0.03
    printf '\n'
    printf '\033[0m'
    ...
    echo ""
    printf '\033[0;34m'
    typewriter "[2/2] Finalizing installation..." 0.03
    printf '\n'
    printf '\033[0m'
fi
...
printf '\n'
typewriter "[SUCCESS] Emotion Detection ANN Ready" 0.03
printf '\n'
printf '\033[0m'

echo ""
printf '\033[0;36m'
typewriter "To start the app: python app.py" 0.03
printf '\n'
typewriter "Then open the URL shown in your terminal" 0.03
printf '\n'
printf '\033[0m'

echo ""
echo "Repo: https://github.com/issu321/Emotion-Detection-Using-ANN"
echo "Author: https://github.com/issu321"
echo ""

printf '\033[0;35m'
typewriter "[LAUNCH] Preparing to start Emotion Detection ANN..." 0.03
printf '\n'
printf '\033[0m'
